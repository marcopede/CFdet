    ...
    if ( m_grid_graph )
	{
	    if ( m_smoothType != FUNCTION  )
		{
			...
			for ( x = 1; x < m_width; x++ )
                ...
                //printf("(%f,%f)",weight,m_V(m_answer[pix],m_answer[pix-1]));
                //printf("%f ",m_V(m_answer[pix],m_answer[pix-1]));
			    }
                //printf("\n");
            }
            //printf("\n");
			...
			for ( x = 0; x < m_width; x++ )
                ...
                //printf("(%f,%f)",weight,m_V(m_answer[pix],m_answer[pix-m_width]));
                //printf("%f ",m_V(m_answer[pix],m_answer[pix-m_width]));
			    }
                //printf("\n");
            }
            //printf("----------------------\n");
