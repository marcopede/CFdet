...
def w2model(descr,rho,lev,fsz,fy=[],fx=[],bin=5,siftsize=2,deform=False,usemrf=False,usefather=False,k=1,mindef=0.0,useoccl=False,usebow=False,useCRF=False,small2=False):
